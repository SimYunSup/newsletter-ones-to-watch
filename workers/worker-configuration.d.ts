/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/workers/worker-configuration.d.ts --config ./src/workers/wrangler.jsonc` (hash: bdea216a789ed1e8e65808726b363b10)
